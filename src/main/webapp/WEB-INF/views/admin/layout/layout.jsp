<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <title>
                <c:out value="${empty pageTitle ? 'Quản trị - Áo Vớ Vẩn' : pageTitle}" />
            </title>
                    ...
                    <header class="mb-3">
                        <nav class="navbar navbar-expand navbar-light bg-light py-2 px-3 shadow-sm rounded">
                            <div class="container-fluid" style="display: flex; align-items: center;">
                                <a href="#" class="burger-btn me-3 d-flex align-items-center justify-content-center"
                                    style="padding: 0; text-decoration: none;">
                                    <i class="bi bi-justify fs-3 m-0" style="line-height: 0;"></i>
                                </a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <div class="dropdown ms-auto">
                                        <a href="#" data-bs-toggle="dropdown" aria-expanded="false"
                                            ...
                                            <div class="user-menu d-flex align-items-center">
                                                <div class="user-name text-end me-3">
                                                    <h6 class="mb-0 text-gray-600 font-bold">
                                                        <c:out value="${sessionScope.user.name}" />
                                                    </h6>
                                                    <p class="mb-0 text-sm text-gray-400">Admin</p>
                                                </div>
                                                <div class="user-img d-flex align-items-center">
                                                    <div class="avatar avatar-md bg-warning text-dark font-bold d-flex align-items-center justify-content-center"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm"
                                            ...
                                            <li><a class="dropdown-item" href="<c:url value='/home' />"><i
                                                        class="bi bi-house-door me-2"></i> Trang chủ</a></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="dropdown-item text-danger" href="<c:url value='/logout' />"><i
