                    ...
                    <nav aria-label="Product list pagination" class="mt-5">
                        <ul class="pagination justify-content-center flex-wrap gap-1">
                            <li class="page-item ${page <= 1 ? 'disabled' : ''}">
                                <a class="page-link border-0 shadow-sm rounded-3 px-3 py-2" href="<c:url value='/products'/>?page=${page - 1}${queryParams}">
                            ...
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                <li class="page-item ${i == page ? 'active' : ''}">
                                    <a class="page-link border-0 shadow-sm rounded-3 px-3 py-2 font-bold ${i == page ? 'bg-warning text-dark' : 'bg-white text-dark'}" href="<c:url value='/products'/>?page=${i}${queryParams}">${i}</a>
                                </li>
                            </c:forEach>
