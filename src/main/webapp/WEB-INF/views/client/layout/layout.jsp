        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6">
                    <a class="navbar-brand logo-text d-inline-block mb-3" href="<c:url value='/home' />">
                        <img src="<c:url value='/assets/images/logo/logo.png' />" alt="" style="width: 36px; height: auto; display: flexbox; align-items: center;"></img>
                        ÁO VỚ VẨN
                    </a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <img src="<c:url value='/assets/images/logo/logo.png' />" alt="Ao Vo Van"
                        height="24" class="me-2 opacity-75" title="Áo Vớ Vẩn">
                </div>
            </div>
        </div>
    </footer>
