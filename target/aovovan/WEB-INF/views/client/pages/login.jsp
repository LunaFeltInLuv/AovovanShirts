        ...
        <div class="row h-100 g-0">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-4">Đăng nhập bằng thông tin tài khoản bạn đã đăng ký.</p>
                    ...
                    <c:if test="${param.registered eq 'true'}">
                        <div class="alert bg-light-success text-success rounded-3 mb-3 p-3" role="alert">
                    ...
                    <form action="<c:url value='/login' />" method="post">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="username" class="form-control form-control-xl" placeholder="Tên đăng nhập" required autofocus>
                        ...
                        <button class="btn btn-warning btn-block btn-lg shadow-lg mt-3 py-2">ĐĂNG NHẬP</button>
                    </form>
                    <div class="text-center mt-5 fs-5">
                        <p class="text-gray-600">Chưa có tài khoản? <a href="<c:url value='/register' />" class="font-bold text-warning text-decoration-none">Đăng ký ngay</a>.</p>
