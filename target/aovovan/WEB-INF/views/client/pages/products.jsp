...
<div class="container">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 border-bottom pb-3 gap-3">
        <h2 class="font-bold text-dark mb-0 fs-3"><i class="bi bi-grid me-2 text-secondary" style="color: #475569 !important;"></i>Danh Sách Sản Phẩm</h2>
        <form action="<c:url value='/products' />" method="get" style="max-width: 350px; width: 100%;">
            <div class="input-group shadow-sm rounded-3">
                <input class="form-control" type="search" name="keyword" value="${keyword}" placeholder="Tìm kiếm áo..." aria-label="Search" style="border-color: #CBD5E1;">
